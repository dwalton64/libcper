...
///
/// CPAD Header Flags
/// Inherited from the CPER specification (UEFI spec Table N.2), treated as a
/// bitfield.  All values other than those defined below are reserved and must
/// be set to zero.
///@{
#define RESERVED_SET_TO_ZERO 0x00000000
///
/// HW_ERROR_FLAGS_SIMULATED: Qualifies that a CPAD was generated by an error
/// condition that was intentionally caused (e.g. error injection).
///
#define CPAD_FLAGS_SIMULATED BIT2
///@}
