...
///@{
#define EFI_PLATFORM_ACTION_RECORD_ID_VALID	     			BIT0
#define EFI_PLATFORM_ACTION_CPAD_SECTION_OFFSET_VALID		BIT1
#define EFI_PLATFORM_ACTION_SOURCE_ID_VALID					BIT2
#define EFI_PLATFORM_ACTION_ACTION_RETURN_CODE_VALID		BIT3
#define EFI_PLATFORM_ACTION_ADDITIONAL_CONTEXT_VALID		BIT4
///@}
