...
#define EFI_PLATFORM_MEMORY_ERROR_MULTIBIT_ECC		 0x03
...
#define EFI_PLATFORM_MEMORY2_ERROR_MULTIBIT_ECC		 0x03
...
extern EFI_GUID gEfiPlatformActionEvent;
...
///
/// Platform Action Event Structure
///
/// This CPER structure is used to report the status of an action taken by a 
/// RAS API endpoint in response to a Commom Platform Action Descriptor (CPAD).
///

///
/// Validation bitmask for Platform Action Events.
///@{
#define EFI_PLATFORM_ACTION_RECORD_ID_VALID	     			0x01
#define EFI_PLATFORM_ACTION_CPAD_SECTION_INDEX_VALID		0x02
#define EFI_PLATFORM_ACTION_ACTION_ID_VALID					0x04
#define EFI_PLATFORM_ACTION_ACTION_RETURN_CODE_VALID		0x08
#define EFI_PLATFORM_ACTION_ADDITIONAL_CONTEXT_VALID		0x10
#define EFI_PLATFORM_ACTION_VALID_MASK					\					
